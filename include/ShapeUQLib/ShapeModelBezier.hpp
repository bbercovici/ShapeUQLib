...
public:
	...
	*/
	...
	/**
	Constructs the coefficient tables necessary for evaluation of the deterministic
	inertia parameters (volume, center of mass, inertia)
	*/
	void populate_mass_properties_coefs_deterministics();


	/**
	Constructs the coefficient tables necessary for evaluation of the stochastics of
	inertia parameters (volume, center of mass, inertia)
	*/
...
protected:
	...
	*/
	...
	with respect to the inertia tensor components
	*/
	arma::mat::fixed<3,6> partial_sigma_partial_I() const;


	/**
	Returns the partial derivative of the inertia moments (A,B,C)
	with respect to the inertia tensor components
	@return partial derivative of the inertia moments
	with respect to the inertia tensor components
	*/
	arma::mat::fixed<3,6> partial_ABC_partial_I() const;



	/**
	Returns the partial derivative of the principal dimensions
	with respect to the principal momnents
	@return partial derivative of the principal dimensions
	with respect to the principal moments
	*/
	arma::mat::fixed<3,4> partial_dim_partial_moments() const;
